...
Requires: xdg-utils shared-mime-info hicolor-icon-theme adwaita-icon-theme openbox xscreensaver qt5ct xorg-x11-xinit upower udisks2 xorg-x11-xkb-utils xorg-x11-server-utils
# where is udisks? (needed for optical media since udisks2 broke this)
