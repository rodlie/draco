...
QList<PAGEINFO> Pages::KnownPages(){
  ...
  list << Pages::PageInfo("autostart", QObject::tr("Autostart"), QObject::tr("Startup Settings"), "preferences-system-session-services",QObject::tr("Automatically start applications or services"), "user", QStringList(), QStringList() << "apps" << "autostart" << "services" << "xdg" << "startup" << "session");
