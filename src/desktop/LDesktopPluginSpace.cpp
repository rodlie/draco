...
void LDesktopPluginSpace::addDesktopPlugin(QString plugID)
{
    ...
    if (plug==Q_NULLPTR){ return; } // invalid plugin
...
QRect LDesktopPluginSpace::findOpenSpot(int gridwidth,
                                        int gridheight,
                                        int startRow,
                                        int startCol,
                                        bool reversed,
...
QRect LDesktopPluginSpace::findOpenSpot(QRect grid, QString plugID, bool recursive)
{
